This is a slightly changed version of rlkit tag v0.1.2 by Vitchyr Pong.
This repository is only provided for convenience when using the Coadaptation repository.
I added the possibility to SAC to set the alpha parameter in the constructor.

You can find the original repository here: https://github.com/vitchyr/rlkit
